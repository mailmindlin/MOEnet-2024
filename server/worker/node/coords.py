...
@overload
def wpi_to_cv2(tf_cv2: Transform3d) -> Transform3d: ...
@overload
def wpi_to_cv2(tf_cv2: Pose3d) -> Pose3d: ...
@overload
def wpi_to_cv2(tf_cv2: Rotation3d) -> Rotation3d: ...
@overload
def wpi_to_cv2(tf_cv2: Translation3d) -> Translation3d: ...
